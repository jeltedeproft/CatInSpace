...
public class KeyBindings {
	...
	public static void loadBindings() {
		...
		if (map.containsKey(Variables.DASH)) {
			keyBindings.put(Variables.DASH, bindingsPreferences.getInteger(Variables.DASH));
		} else {
			keyBindings.put(Variables.DASH, MyKeys.RIGHT_MOUSE);
		}
		if (map.containsKey(Variables.ACTION_1)) {
			keyBindings.put(Variables.ACTION_1, bindingsPreferences.getInteger(Variables.ACTION_1));
		} else {
			keyBindings.put(Variables.ACTION_1, MyKeys.CONTROL_LEFT);
		}
		if (map.containsKey(Variables.ACTION_2)) {
			keyBindings.put(Variables.ACTION_2, bindingsPreferences.getInteger(Variables.ACTION_2));
		} else {
			keyBindings.put(Variables.ACTION_2, MyKeys.A);
		}
